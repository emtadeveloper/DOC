...
رو برای خودش در نظر میگیره و اگر ما بخایم بیایم و یک متغیر execution context ما وقتی میایم و یک تابع رو می نویسیم این تابع میاد و یک 
خودش رو چک میکنه اگر موجود بود که اجرا میکنه در غیر این صورت variable Envirment  رو درون اون چک بکنیم در مرحله اول میاد و اصطلاحا اون
میاد و یک مرحله میره بالاتر و اون جا رو چک میکنه

Scope Chaing  اصطلاحا به این حالت که هی میره و اسکوپ های بالاترش رو چک میکنه رو بهش میگویند 

outer Vaiable : به این معنی هستش که ما یک متغیر رو بیایم و خارج از اسکوپ اون متغیر تعریف اش بکنیم

global variable : متغیری که میاد و تو اسکوپ گلوبال امون تعریف میشه رو میگویند

ما چون توابع امون یک نوع اکشن هستند در نتیجه اکشن هامون باید از نوع فعل باشند تا بهتر بتونن خودشونو نشون بدن

توابع باید فقط یک کار رو بیان و انجام بدهند
